...
if DEBUG:
    ...
    DEFAULT_FROM_EMAIL = "noreply@autopos.test"
else:
    # Production: Use SMTP
    ...
    DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="noreply@batstate-u.edu.ph")

# Site URL (used in email templates for login links)
